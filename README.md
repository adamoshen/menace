...
package includes Markdown formatters compatible with Microsoft Teams.
For other destinations, consider the usage of the Markdown functions
contained in [**gluedown**](https://k5cents.github.io/gluedown/).
